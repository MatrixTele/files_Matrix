...
local function keko_Matrix(data)
    ...
    database:del('Matrix:'..bot_id.."charge:"..msg.chat_id_)
    function TSby(extra,result,success)
    function thsake_info2(k1,k2)
    function dl_cb222(t1,t2)
    send(tostring((database:get("Matrix"..bot_id..":sudo:gr") or sudo_add)), 0, 1, "🔘┇قام بطرد البوت من المجموعه \n🎫┇ايدي الشخص ~⪼ ("..msg.sender_user_id_..")\n📜┇معرف الشخص ~⪼ @"..(result.username_ or "لا يوجد").."\n🌐┇معلومات المجموعه \n\n🎫┇ايدي المجموعه ~⪼ ("..msg.chat_id_..")\nⓂ️┇اسم المجموعه ~⪼ ("..k2.title_..")\n📎┇رابط المجموعه ~⪼ ["..(t2.invite_link_ or database:get('Matrix:'..bot_id.."group:link"..msg.chat_id_) or "لا يمكنني الوصول الى الرابط").."]" , 1, 'html')
    end
    tdcli_function ({
    ID = "GetChannelFull",
