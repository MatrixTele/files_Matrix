...
local function keko_Matrix(data)
    ...
    if not database:get("Matrix:get:my:frind:gr:"..bot_id..msg.chat_id_) then 
    ...
    resolve_username(keko_ts[1],Matrix_get)
    end
    ...
    database:set("Matrix:get:my:frind:gr:"..bot_id..msg.chat_id_,"Matrix")
    send(msg.chat_id_, msg.id_, 1, "🔘┇ تم تعطيل صيح", 1, 'html')
    end 
    if text and text == "تفعيل صيح" then 
    database:del("Matrix:get:my:frind:gr:"..bot_id..msg.chat_id_)
