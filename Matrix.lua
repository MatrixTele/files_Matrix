...
if text and database:get(bot_id..'Matrix:lock:Fshar'..msg.chat_id_) and not Constructor(msg) then 
...
database:set(bot_id.."Matrix:Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
database:sadd(bot_id.."Matrix:List:Cmd:Group:New"..msg.chat_id_,"غ")
database:set(bot_id.."Matrix:Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
database:sadd(bot_id.."Matrix:List:Cmd:Group:New"..msg.chat_id_,"،،")
...
local t = ' \n܁༯┆تم تفعيل الشعر'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'Rio:sher:Rio'..msg.chat_id_) 
end
...
if Text and Text:match('(.*)/shhar') then
local Userid = Text:match('(.*)/shhar')
if tonumber(Userid) ~= tonumber(data.sender_user_id_) then
https.request("https://api.telegram.org/bot"..token..'/answerCallbackQuery?callback_query_id='..data.id_..'&text='..URL.escape('الامر لا يخصك')..'&show_alert=true')
end
data,res = https.request('https://uussuu.ml/audioss/shaer.php')
...
{
{text = '- ??????𝗿𝗶𝗫 𝗧𝗲𝗮𝗠 .',url="https://t.me/Matrix_Source"},
},
}
...
𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄𓐄
܁༯┆قناة البوت ↺* [- 𝗠𝗮𝗧𝗿𝗶𝗫 𝗧??𝗮𝗠 .](t.me/Matrix_Source)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
